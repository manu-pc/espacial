...
public class VLibro extends javax.swing.JDialog {
    ...
    public VLibro(java.awt.Frame parent, boolean modal, aplicacion.FachadaAplicacion fa, java.util.List<String> restoCategorias) {
        ...
        if (!e.getValueIsAdjusting()) { 
            ...
            if (selectedRow != -1) { 
                Object usuario = tablaEjemplares.getValueAt(selectedRow, 3); 
                btnPrestar.setEnabled(usuario == null && tablaEjemplares.getRowCount()>0);
                btnDevolver.setEnabled(usuario!=null);
            }
        }
    });
    ...
    public VLibro(java.awt.Frame parent, boolean modal, aplicacion.FachadaAplicacion fa, Libro libro, java.util.List<String> categorias, java.util.List<String> restoCategorias) {
        ...
        if (!e.getValueIsAdjusting()) { 
            ...
            if (selectedRow != -1) { 
                Object usuario = tablaEjemplares.getValueAt(selectedRow, 3); 
                btnPrestar.setEnabled(usuario == null);
                btnDevolver.setEnabled(usuario!=null);
            }
        }
    });
    ...
    private void actualizarEjemplares(){
      ...
      ejemplaresBorrados.clear();
    }

    private void btnPrestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrestarActionPerformed
        int filaTabla = tablaEjemplares.getSelectedRow();
    ...
    private void btnDevolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDevolverActionPerformed
        ...
        if (filaTabla != -1) { // Check if a row is selected
            ModeloTablaEjemplares modelo = (ModeloTablaEjemplares) tablaEjemplares.getModel();
            String idUsuario = (String) modelo.getValueAt(filaTabla, 3);
