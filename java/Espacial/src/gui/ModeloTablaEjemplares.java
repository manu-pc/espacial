...
public class ModeloTablaEjemplares extends AbstractTableModel{
    ...
    public Class getColumnClass(int col){
        ...
        switch (col){
            ...
            case 5: clase=java.time.LocalDate.class; break;
        }
        return clase;
    }
    ...
    public Object getValueAt(int row, int col){
        ...
        switch (col){
            ...
            case 3: resultado=ejemplares.get(row).getUsuarioId(); break;
    ...
    public Ejemplar getEjemplar(int row){
        return ejemplares.get(row);
    }
